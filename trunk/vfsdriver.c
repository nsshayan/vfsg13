...
void createvfs ( char *P1, int P2 )
{
	createvfs(P1,P2);/* Call the appropriate function with given arguments and display appropriate output on the screen */
	printf("createvfs_TO_BE_DONE\n");
}

void mountvfs ( char *P1 )
{
	mountvfs(P1);/* Call the appropriate function with given arguments and display appropriate output on the screen */
	printf("mountvfs_TO_BE_DONE\n");
}

void unmountvfs ( char *P1 )
{
	unmountvfs(P1);/* Call the appropriate function with given arguments and display appropriate output on the screen */
	printf("unmountvfs_TO_BE_DONE\n");
}

void makedir ( char *P1, char *P2 )
{
	makedir(P1,P2);/* Call the appropriate function with given arguments and display appropriate output on the screen */
	printf("makedir_TO_BE_DONE\n");
}

void deletedir ( char *P1 )
{
	deletedir(P1);/* Call the appropriate function with given arguments and display appropriate output on the screen */
	printf("deletedir_TO_BE_DONE\n");
}

void movedir ( char *P1, char *P2 )
{
	movedir(P1,P2);/* Call the appropriate function with given arguments and display appropriate output on the screen */
	printf("movedir_TO_BE_DONE\n");
}

void listdir ( char *P1, int P2, char *P3 )
{
	listdir(P1,P2,P3);/* Call the appropriate function with given arguments and display appropriate output on the screen */
	printf("listdir_TO_BE_DONE\n");
}

void addfile ( char *P1, char *P2, char *P3 )
{
	addfile(P1,P2,P3);/* Call the appropriate function with given arguments and display appropriate output on the screen */
	printf("addfile_TO_BE_DONE\n");
}

void listfile ( char *P1, char *P2 )
{
	listfile(P1,P2);/* Call the appropriate function with given arguments and display appropriate output on the screen */
	printf("listfile_TO_BE_DONE\n");
}

void updatefile ( char *P1, char *P2 )
{
	updatefile(P1,P2);/* Call the appropriate function with given arguments and display appropriate output on the screen */
	printf("updatefile_TO_BE_DONE\n");
}

void removefile ( char *P1 )
{
	removefile(P1);/* Call the appropriate function with given arguments and display appropriate output on the screen */
	printf("removefile_TO_BE_DONE\n");
}

void movefile ( char *P1, char *P2 )
{
	movefile(P1,P2);/* Call the appropriate function with given arguments and display appropriate output on the screen */
	printf("movefile_TO_BE_DONE\n");
}

void copyfile ( char *P1, char *P2 )
{
	copyfile(P1,P2);/* Call the appropriate function with given arguments and display appropriate output on the screen */
	printf("copyfile_TO_BE_DONE\n");
}

void exportfile ( char *P1, char *P2 )
{
	exportfile(P1,P2);/* Call the appropriate function with given arguments and display appropriate output on the screen */
	printf("exportfile_TO_BE_DONE\n");
}

void searchfile ( char *P1, char *P2 )
{
	searchfile(P1,P2);/* Call the appropriate function with given arguments and display appropriate output on the screen */
